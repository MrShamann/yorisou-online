...
--   -- (restore the original event_type check from 202607190002 if fully reverting)
...
-- (companion_use / recommendation_use / community_use already exist from 202607190002)
...
-- inline check from 202607190002 is a table constraint; add a superseding named
...
-- The append-only guard + RLS from 202607190002 remain in force on these tables.
