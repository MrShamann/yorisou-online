...
**Identity / Recovery:** Email, with linkable approved authentication identities  
...
Only files in this `current` directory may be used as active governance. Superseded v0.3 channel wording and all Draft/Rev/intermediate copies must not remain active beside this release.

## Document index

- `Yorisou_AI_Native_Product_and_Agent_Capability_Map_v0.3.1.md`
- `Yorisou_AI_Usage_and_Recommendation_Governance_v0.3.md`
- `Yorisou_Agent_Contract_Standard_v0.1.md`
- `Yorisou_Agent_Operating_System_Execution_Blueprint_v0.3.md`
- `Yorisou_Agent_Skill_OpenClaw_and_Hermes_Governance_v0.3.md`
- `Yorisou_Akari_Platform_Orchestrator_Role_Specification_v0.2.md`
- `Yorisou_Board_Decision_Register_Template_v0.3.md`
- `Yorisou_Business_Model_and_Platform_Architecture_Doctrine_v0.3.1.md`
...
- `Yorisou_Product_Doctrine_and_UX_Boundary_v0.3.1.md`
- `Yorisou_Project_Constitution_v0.3.1.md`
- `Yorisou_Recommendation_and_Resource_Matching_Policy_v0.3.md`
- `Yorisou_Revenue_Model_and_Commercial_Ethics_Policy_v0.3.md`
- `Yorisou_Risk_Register_Template_v0.3.md`
- `Yorisou_Stakeholder_Communication_and_External_Representation_Governance_v0.3.1.md`
- `Yorisou_Strategic_Doctrine_v0.3.1.md`
- `Yorisou_Task_and_Execution_Register_Template_v0.3.md`
- `Yorisou_Technical_Architecture_and_Execution_Protocol_v0.3.1.md`
