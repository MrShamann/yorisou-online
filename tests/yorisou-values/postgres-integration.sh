...
begin
  ...
  perform public.yorisou_values_assessment_correct('owner-a'::text, v_id, '{"VAL_Q01":"B"}'::jsonb, 'VAL_R_PACE'::text, false, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text);
...
select assert_true(not has_function_privilege('anon','public.yorisou_values_assessment_set_confirmation(text,uuid,text,text,text,text,text,text,text)','execute'),'anon set_confirmation denied');
select assert_true(has_function_privilege('service_role','public.yorisou_values_assessment_set_confirmation(text,uuid,text,text,text,text,text,text,text)','execute'),'service-role set_confirmation allowed');
do $$
declare v_id uuid; v_versions int; v_updated timestamptz;
begin
  ...
  perform public.yorisou_values_assessment_set_confirmation('owner-a'::text, v_id, 'confirmed'::text, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text);
  ...
  perform public.yorisou_values_assessment_set_confirmation('owner-a'::text, v_id, 'not_quite'::text, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text);
  ...
  -- YV-1.2 (YV-C8): IDEMPOTENT — requesting the confirmation the record already
  -- holds ('not_quite') is a truthful no-op: NO new event, updated_at NOT bumped,
  -- version unchanged.
  select updated_at into v_updated from yorisou_values_assessments where id=v_id;
  perform pg_sleep(0.02);
  perform assert_true(public.yorisou_values_assessment_set_confirmation('owner-a'::text, v_id, 'not_quite'::text, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text)='not_quite','idempotent set_confirmation returns the confirmation (truthful no-op success)');
  perform assert_true((select count(*)=2 from yorisou_values_assessment_events where assessment_id=v_id and event_type='confirmation_changed'),'idempotent set_confirmation appends NO additional event (still 2)');
  perform assert_true((select updated_at=v_updated from yorisou_values_assessments where id=v_id),'idempotent set_confirmation does NOT bump updated_at');
  perform assert_true((select current_version=2 from yorisou_values_assessments where id=v_id),'idempotent set_confirmation does NOT change version');
end $$;
do $$ declare v_id uuid; begin select id into v_id from yorisou_values_assessments where owner_account_id='owner-a' and current_version=2 limit 1; perform public.yorisou_values_assessment_set_confirmation('owner-a'::text, v_id, 'maybe'::text, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text); raise exception 'invalid confirmation accepted'; exception when others then if position('values_invalid_confirmation' in sqlerrm)=0 then raise; end if; end $$;
do $$ declare v_id uuid; begin select id into v_id from yorisou_values_assessments where owner_account_id='owner-a' and current_version=2 limit 1; perform public.yorisou_values_assessment_set_confirmation('owner-a'::text, v_id, 'confirmed'::text, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v0.9'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text); raise exception 'stale-provenance confirmation accepted'; exception when others then if position('values_record_contract_version_mismatch' in sqlerrm)=0 then raise; end if; end $$;
do $$ declare v_id uuid; begin select id into v_id from yorisou_values_assessments where owner_account_id='owner-a' and current_version=2 limit 1; perform public.yorisou_values_assessment_set_confirmation('owner-b'::text, v_id, 'confirmed'::text, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text); raise exception 'cross-owner confirmation accepted'; exception when others then if position('values_record_not_found' in sqlerrm)=0 then raise; end if; end $$;
-- YV-1.2 (YV-C6): a WRONG expected method_id is rejected by BOTH mutation RPCs
-- (the six-field contract — the CHECK constraint is not a substitute).
do $$ declare v_id uuid; begin select id into v_id from yorisou_values_assessments where owner_account_id='owner-a' and current_version=2 limit 1; perform public.yorisou_values_assessment_correct('owner-a'::text, v_id, '{"VAL_Q01":"A"}'::jsonb, 'VAL_R_ANSHIN'::text, false, 'not-yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text); raise exception 'wrong method_id correction accepted'; exception when others then if position('values_record_contract_version_mismatch' in sqlerrm)=0 then raise; end if; end $$;
do $$ declare v_id uuid; begin select id into v_id from yorisou_values_assessments where owner_account_id='owner-a' and current_version=2 limit 1; perform public.yorisou_values_assessment_set_confirmation('owner-a'::text, v_id, 'confirmed'::text, 'not-yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text); raise exception 'wrong method_id confirmation accepted'; exception when others then if position('values_record_contract_version_mismatch' in sqlerrm)=0 then raise; end if; end $$;
-- reset confirmation to skipped so the downstream deletion assertions are unaffected
select public.yorisou_values_assessment_set_confirmation('owner-a'::text, (select id from yorisou_values_assessments where owner_account_id='owner-a' and current_version=2 limit 1), 'skipped'::text, 'yorisou-values'::text, 'values-v1.0'::text, 'values-bank-v1.0'::text, 'values-scoring-v1.0'::text, 'values-result-v1.0'::text, '919f1725'::text);
