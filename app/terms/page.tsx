...
export default function TermsPage() {
  return (
    <main>
      <Hero
        title="利用規約"
        subtitle="本利用規約（以下「本規約」といいます。）は、Yorisou（以下「本サービス」といいます。）の利用条件を定めるものです。ユーザーは、本サービスを利用することにより、本規約に同意したものとみなされます。"
      />

      <Section label="1" title="適用">
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            本規約は、本サービスのウェブサイト、LINE MINI App、LINE連携機能、診断コンテンツ、結果表示、関連する継続コンテンツその他本サービスに関する一切の利用に適用されます。
          </p>
        </div>
      </Section>

      <Section label="2" title="本サービスの内容">
        <div className="card">
      ...
      <Section label="3" title="利用登録・アカウント">
        <div className="card">
          <ol className="list-clean" style={{ margin: 0, display: "grid", gap: 8, paddingLeft: 18 }}>
      ...
      <Section label="6" title="外部サービス連携">
        <div className="card">
          <ol className="list-clean" style={{ margin: 0, display: "grid", gap: 8, paddingLeft: 18 }}>
      ...
      <Section label="8" title="サービスの変更・停止・終了">
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            当社は、保守、障害対応、仕様変更、法令対応、事業上の判断その他の理由により、ユーザーへの事前通知なく、本サービスの全部または一部を変更、停止または終了することがあります。
          </p>
        </div>
      </Section>

      <Section label="9" title="規約違反時の措置">
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            当社は、ユーザーが本規約に違反し、または違反するおそれがあると判断した場合、事前通知なく、投稿・データの削除、機能制限、利用停止、アカウント削除その他必要な措置を講じることができます。
          </p>
        </div>
      </Section>

      <Section label="10" title="プライバシー">
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            本サービスにおける個人情報その他ユーザー情報の取扱いは、別途定める「プライバシーポリシー」に従います。
          </p>
        </div>
      </Section>

      <Section label="11" title="本規約の変更">
        <div className="card">
          <ol className="list-clean" style={{ margin: 0, display: "grid", gap: 8, paddingLeft: 18 }}>
      ...
      <Section label="12" title="準拠法・管轄">
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            本規約は日本法に準拠して解釈されます。本サービスに関して当社とユーザーとの間で紛争が生じた場合には、当社の主たる事業所所在地を管轄する地方裁判所または簡易裁判所を第一審の専属的合意管轄裁判所とします。
          </p>
        </div>
      </Section>

      <Section label="13" title="お問い合わせ">
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            本規約に関するお問い合わせは、当社が本サービス上で別途表示する窓口までご連絡ください。
          </p>
        </div>
      </Section>
