...
export const ja: SiteCopy = {
  ...
  buildWithUs: {
    ...
    lead:
      "いまは、話せる範囲から始めています。決まった募集の枠があるわけではありません。関心があれば、まず内容を教えてください。",
    lanes: [
      {
        key: "founders",
        title: "創業者・運営者",
        body:
          "YORISOU は、会社になる手前まで進めた事業をつくっています。それを自分のものとして背負える人と組みたいと考えています。雇用として引き受ける仕事ではなく、創業として引き受ける立場です。",
        invites: [
      ...
      },
      {
        ...
        title: "行政・公共",
        body:
          "公共の課題は、制度があっても住民の手順に翻訳されていないことが多くあります。小さく試し、効果を測り、続く形にするところまでを一緒に設計したいと考えています。",
        invites: [
          "実地で試せる課題がある",
          "効果を測れる形にしたい",
          "一度きりの実証で終わらせたくない",
