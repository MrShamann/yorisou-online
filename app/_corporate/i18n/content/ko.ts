...
export const ko: SiteCopy = {
  ...
  home: {
    ...
    lead: [
      ...
      "그 사업을 운영할 사람들과 팀을 이루어 독립된 회사로 만들어 가는 파운드리입니다.",
    ],
    humanSide: "사람",
    humanItems: ["생활", "일", "지역"],
    systemSide: "구조",
    ...
    asterionBody:
      "Asterion OS는 Yorisou의 파운드리 구상 안에 자리한, 독립된 공통 기술·실행 기반입니다. 같은 구조를 몇 번씩 다시 만들지 않아도 되는 만큼, 각 사업은 자기 영역에 집중할 수 있습니다.",
    asterionNote:
      "각 사업은 각각 독립된 거버넌스 아래 있으며, 지식재산·데이터·운영 책임도 각 사업에 속합니다. Asterion은 Yorisou의 소유물이 아닙니다.",
  ...
  ventures: {
    ...
    noteBody: [
      ...
      "회사로서 독립해 설 수 있는 상태를 목표로 하고 있지만, 아직 거기에 이른 것은 없습니다.",
    ],
  },
  ...
  foundry: {
    ...
    lead:
      "떠오른 생각에서 시작하지 않습니다. 구조적인 문제를 찾아내고, 확인하고, 사업으로 설계하고, 운영할 수 있는 사람과 팀을 이루어, 독립된 회사로 만들어 갑니다. Yorisou는 이 순서를 파운드리라고 부릅니다.",
    stagesEyebrow: "단계",
    ...
    stages: [
      ...
      { no: "05", name: "사업으로 설 수 있는 상태", body: "밖의 사람이 이어받아 운영할 수 있는 상태까지, 자산과 절차를 정비합니다." },
      { no: "06", name: "창업 팀 구성", body: "그 사업을 자기 것으로 짊어질 수 있는 사람과 팀을 이룹니다. 고용이 아니라, 창업으로서." },
      { no: "07", name: "독립·운영", body: "독립된 회사로서 움직입니다. Yorisou에 계속 의존하지 않는 형태를 지향합니다." },
      { no: "08", name: "학습", body: "잘된 것도, 사라진 가설도, 다음 사업을 위한 재료로 남깁니다." },
    ],
    independenceHeading: ["목적은,", "스스로 서는 회사."],
    independenceBody: [
      "파운드리의 목적은 Yorisou의 산하를 늘리는 것이 아닙니다. 독립된 회사로서 스스로 설 수 있는 상태로 만드는 것입니다.",
      "그래서 처음부터 이어받을 수 있는 형태로 만듭니다. 운영하는 사람이 진짜 결정권을 가질 수 없다면, 그것은 회사가 된 것이 아닙니다.",
    ],
    asterionEyebrow: "공통 기술·실행 기반",
    asterionHeading: ["같은 것을,", "두 번 만들지 않습니다."],
    asterionBody: [
      "Asterion OS는 Yorisou의 파운드리 구상 안에 자리한, 독립된 공통 기술·실행 기반입니다. Yorisou가 소유하고 있는 것이 아닙니다.",
      "공통의 기반이 있는 만큼, 각 사업은 같은 구조를 다시 만들지 않아도 되고 자기 영역에 집중할 수 있습니다. 쌓인 역량은 다음 사업의 출발점이 됩니다.",
    ],
    asterionBoundaryTitle: "경계",
    asterionBoundaryBody:
      "각 사업은 각각 별도의 거버넌스 아래 있습니다. 지식재산·데이터·운영 책임은 각 사업에 속합니다. 사업이나 이용자의 데이터가 자동으로 기반 쪽으로 흘러가는 설계는 하지 않았습니다.",
  ...
  buildWithUs: {
    ...
    lead:
      "지금은 이야기할 수 있는 범위에서 시작하고 있습니다. 정해진 모집 절차가 있는 것은 아닙니다. 관심이 있다면 먼저 어떤 내용인지 알려 주세요.",
    lanes: [
      {
        key: "founders",
        title: "창업자·운영자",
        body:
          "Yorisou는 회사가 되기 직전까지 진행한 사업을 만들고 있습니다. 그것을 자기 것으로 짊어질 수 있는 사람과 함께하고 싶습니다. 고용으로 맡는 일이 아니라, 창업으로 맡는 자리입니다.",
        invites: [
      ...
      },
      {
        ...
        title: "행정·공공",
        body:
          "공공의 문제는 제도가 있어도 주민의 절차로 번역되지 않은 경우가 많습니다. 작게 시험하고, 효과를 재고, 이어질 수 있는 형태로 만드는 데까지 함께 설계하고자 합니다.",
        invites: [
