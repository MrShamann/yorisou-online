  ...
  return (
    <section className="section">
      <div className="container">
        <div className="rounded-[1.75rem] bg-[rgba(255,253,249,0.72)] px-6 py-7 md:flex md:items-end md:justify-between md:px-8 md:py-8">
          <div className="max-w-[38rem]">
            <div className="service-kicker">YORISOU</div>
            <h3 className="display-serif mt-4 max-w-[15em] text-[1.75rem] leading-[1.5] text-[var(--text)] md:text-[2rem]">{title}</h3>
