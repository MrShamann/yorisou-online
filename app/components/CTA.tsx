  ...
  return (
    <section className="section">
      <div className="container">
        <div className="rounded-[2rem] border border-[#D8C6B4]/24 bg-[#FFFBF6] px-6 py-7 shadow-[0_14px_30px_rgba(47,35,33,0.04)] md:flex md:items-end md:justify-between md:px-8 md:py-8">
