        ...
        <section className="relative w-full overflow-hidden rounded-[2.25rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,16,15,0.98)_0%,rgba(23,34,30,0.98)_57%,rgba(242,246,239,0.99)_100%)] shadow-[0_24px_52px_rgba(10,16,14,0.18)]">
          ...
          <div className="relative space-y-3.5 p-3.5">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="overflow-hidden rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08)_0%,rgba(255,255,255,0.04)_34%,rgba(245,248,243,1)_100%)] p-3.5 text-white shadow-[0_18px_34px_rgba(24,30,28,0.18)]">
              <div className="flex items-start justify-between gap-3">
                <div className="space-y-2">
                  ...
                  <h1 className="display-serif text-[2.32rem] leading-[0.98] tracking-[-0.06em] text-white" data-official-public-persona-name={officialName} data-persona-id={personaShell?.personaId || "fallback"}>
                    {officialName}
                  </h1>
                  {socialHandle ? (
                    <p className="max-w-[18rem] rounded-[1rem] border border-white/12 bg-white/10 px-3 py-2 text-[0.92rem] font-semibold leading-6 text-white" data-social-handle={socialHandle}>
                      {socialHandle}
                    </p>
                  ) : null}
                </div>
                <div className="rounded-[1.25rem] border border-white/12 bg-white/10 px-3 py-2 text-right text-[10px] tracking-[0.16em] text-white/76">
              ...
              <p className="mt-2.5 max-w-[20rem] text-[11.5px] leading-5 text-white/72" data-functional-subtitle={subtitle}>
                {subtitle}
              </p>
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              {traits.map((trait) => (
                <span
                  key={trait}
                  className="rounded-[1rem] border border-[rgba(36,45,43,0.12)] bg-white/92 px-3 py-2.5 text-[12px] font-medium leading-5 text-[var(--text)] shadow-[0_10px_18px_rgba(47,35,33,0.05)]"
