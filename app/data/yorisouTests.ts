...
export const YORISOU_TEST_ENTRIES: readonly YorisouTestEntry[] = [
  ...
  },
  {
    ...
    estimatedTime: "約2分",
    hook: "移動、買い物や通院、家族を支える負担、地域のつながりを、関心の入口として整理します。",
    outcome: "今の関心テーマ、受け取りたい案内、地域の声としての送り先",
    nextLayer: "サービス提供の約束ではなく、生活の声を次の取り組みにつなげる入口です。",
    label: "関心を整理する",
    availableNow: true,
    allowedInterestActions: ["local-life-interest", "community-interest", "design-interest"],
    trustBoundaryNote: "介護・福祉・移動サービスの提供ではなく、関心や相談の入口です。",
  },
] as const;
