...
import { BLOCKERS, PENDING_COMPANY_FIELDS, type RouteSet } from "../_content/site";

/** CORP-P4A — one implementation, rendered at whichever URL set it is given. */
export default function CompanyView({ routes }: { routes: RouteSet }) {
  return (
    <CorporateShell routes={routes} current={routes.company}>
      <PageIntro
        eyebrow="会社情報"
        title="会社情報"
