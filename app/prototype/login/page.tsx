      ...
      <div className="flex min-h-[70dvh] items-center justify-center py-6">
        <div className="w-full max-w-[400px] rounded-[var(--yorisou-radius-hero)] border border-[var(--yorisou-color-neutral-100)] bg-white p-6 shadow-[var(--yorisou-shadow-raised)] md:p-7">
          ...
          <div className="mt-5 grid gap-2.5">
            <button
              type="button"
              className="inline-flex min-h-[50px] items-center justify-center gap-2 rounded-[var(--yorisou-radius-pill)] bg-[#067A34] px-4 text-[14.5px] font-bold text-white transition duration-[var(--yorisou-motion-tap)] hover:bg-[#05622A] active:scale-[0.99]"
            >
