...
import HomeView from "@/app/_corporate/p5r2/views/HomeView";
...
export async function generateMetadata({ searchParams }: { searchParams: SearchParams }): Promise<Metadata> {
  return localeMetadata(searchParams, "home");
}
...
export default async function Page({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <Shell copy={copy} locale={locale} path="/">
      <HomeView copy={copy} locale={locale} />
    </Shell>
  );
}
