          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-[#5A4B3E] md:text-lg">
                Yorisou is a warm, trustworthy mobility brand designed for daily life in Japan.
                Built around companionship, simplicity, and peace of mind, it helps people move
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { title: "安心", text: "Gentle mobility for everyday errands and short-distance trips." },
                  { title: "寄り添う", text: "A brand centered on care, dignity, and human connection." },
                  { title: "シンプル", text: "Easy to understand, easy to use, and easy to trust." },
                ].map((item) => (
                      ...
                      <div className="flex h-full flex-col justify-between">
                        <div className="max-w-sm">
                          ...
                          <p className="mt-3 text-sm leading-6 text-[#5A4B3E]">
                            A calm identity built from Japanese symbolism: the crane for grace and
                            longevity, the ginkgo for resilience, memory, and civic warmth.
                          </p>
                        </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                text: "A warm civic-facing identity that works for pilots, public collaboration, and trust-building.",
              },
            ].map((item) => (
