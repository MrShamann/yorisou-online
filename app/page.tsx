...
const FUTURE_LAYERS = [
  {
    title: "コミュニティ",
    body: "気になるテーマに、フィードバック、試用、生活の観察、アイデアづくりとして任意で参加できます。声は、よりよい診断、レポート、おすすめにつながります。",
  },
  {
    title: "よりそうデザイン",
    body: "診断やフィードバックから見えてきた「あると助かるもの」を、アイデア、試用、共創、商品化へと少しずつ育てていきます。",
  },
  {
    title: "マッチング",
        ...
        <div className="container">
          <div className="grid gap-8 md:grid-cols-[1fr_1fr] md:items-start">
            <div>
              ...
              <p className="aix-band-lead">
                LINEは、診断の代わりではなく、結果や振り返りを無理なく続けるための戻り道です。結果を保存して見返し、必要なときだけ次の入口を受け取り、不要なときは通知を止められます。
              </p>
              <div className="mt-6">
