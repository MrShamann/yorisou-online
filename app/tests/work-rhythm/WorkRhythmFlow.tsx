      ...
      <main className="yr-focus">
        <div className="container py-10 md:py-14">
          <div className="mx-auto max-w-[42rem] space-y-6">
            ...
            <div className="rounded-[1.4rem] border border-[var(--yr-hair)] bg-[var(--yr-panel)] p-6 shadow-[0_18px_40px_rgba(23,59,53,0.08)]">
              <p className="text-[15px] leading-8 text-[color:var(--yr-text-mut)]">{result.detail}</p>
            </div>

            <div className="space-y-2.5">
              {result.bullets.map((bullet) => (
                <div key={bullet} className="rounded-[1rem] border border-[var(--yr-hair)] bg-[var(--yr-panel-2)] px-4 py-3.5">
            ...
            <div className="rounded-[1.2rem] border border-[var(--yr-hair)] bg-[var(--yr-panel)] px-5 py-4">
            ...
            <ShareResultActions
              input={{
                ...
                seed: result.id,
                url: "/tests/work-rhythm",
              }}
              trackingTestId="work-rhythm"
            />
            ...
            <div className="space-y-6">
              <div className="flex flex-wrap gap-1.5">
                {INTRO_PILLS.map((pill) => (
                  <span key={pill} className="inline-flex rounded-full border border-[var(--yr-hair-2)] bg-[var(--yr-panel)] px-3 py-1.5 text-[12px] font-semibold text-[color:var(--yr-text-mut)]">
                    {pill}
                  </span>
                ))}
              </div>
              <div className="space-y-3">
                ...
                <h1 className="display-serif text-[2rem] leading-[1.22] text-[color:var(--yr-text)] md:text-[2.6rem]">
                  進みやすい形を、<br />
                  <span className="text-[color:var(--yr-accent-text)]">今の仕事リズムから軽く見る。</span>
                </h1>
              ...
              <div className="rounded-[1.35rem] border border-[var(--yr-hair)] bg-[var(--yr-panel)] p-5 shadow-[0_16px_36px_rgba(23,59,53,0.07)] space-y-3">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {WHAT_YOU_GET.map((item) => (
                    <div key={item} className="flex items-center gap-2 rounded-[0.9rem] border border-[var(--yr-hair)] bg-[var(--yr-panel-2)] px-3.5 py-2.5">
                      <span className="inline-flex h-4 w-4 items-center justify-center rounded-full bg-[var(--yr-accent)] text-[10px] text-[color:var(--yr-accent-ink)]">✓</span>
            ...
            <div className="space-y-4">
              <div className="rounded-[1.2rem] border border-[var(--yr-hair)] bg-[var(--yr-panel)] p-3.5 shadow-[0_14px_30px_rgba(23,59,53,0.07)]">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="rounded-full bg-[var(--yr-panel-2)] px-3 py-1 text-[12px] font-semibold text-[color:var(--yr-accent-text)]">軽量チェック</div>
                </div>
              </div>
              ...
              <div className="flex gap-2.5">
                <button
                  type="button"
                  onClick={goBack}
                  className="inline-flex min-h-[50px] items-center justify-center rounded-full border border-[var(--yr-hair)] bg-[var(--yr-panel-2)] px-4 text-[14px] font-semibold text-[color:var(--yr-accent-text)] transition hover:-translate-y-0.5"
                >
                  戻る
                </button>
              </div>
