...
export const T6_BASE_RESULTS: T6ResultModel[] = [
  ...
  },
  {
    ...
    publicName: "流れを見て動き直す人",
    recognitionLine: "今は、決めた通りに進めるより、その場の変化を見ながら動き直す力が出やすい状態です。すぐ切り替えられるぶん、後から少し疲れが残ることもあります。",
    recognitionHook: "予定どおりじゃなくても、流れを見てもう一度動き直せる。",
    summary: [
      "今は、決めた通りに進めるより、その場の変化を見ながら動き直す力が出やすい状態です。すぐ切り替えられるぶん、後から少し疲れが残ることもあります。",
    ],
    currentTendencyTitle: "今の動き方",
    currentTendencyBody: "状況が変わったときに、止まるよりも一度動きながら調整しやすいようです。予定が変わっても、大きく乱れる前に別の進め方を探せます。",
    dailyPatternTitle: "日常で出やすい動き",
    dailyPattern: "会話や予定の流れを見て、「じゃあこうしよう」と切り替えることが多そうです。まわりから見ると、対応が早いと感じられることもあるかもしれません。",
    frictionTitle: "つまずきやすいところ",
    frictionPoint: "動き直せるぶん、自分の中で落ち着く前に次へ進んでしまうことがあります。あとから疲れに気づくこともありそうです。",
    nextStepTitle: "小さく試すなら",
    nextStep: [
      "切り替えたあとに、短く一息つく時間を置く。",
      "「今の変更で増えた負荷」をひとつだけ確認する。",
    ],
    shareLine: "予定どおりじゃなくても、流れを見てもう一度動き直せる。",
    reportPreviewBridge: "流れを見ながら動き直せるこの力が、どんな場面で助けになり、どこで疲れにつながりやすいかを、もう少し丁寧に整理できます。",
    traitChips: ["組み直せる", "切り替えが早い", "流れを見て動く"],
...
export const T6_OVERLAYS: T6OverlayModel[] = [
  ...
  },
  {
    ...
    body: "いきなり大きく変えるより、少し連絡してみる、少し出てみる、少し試してみる。そのくらいの動きが、今は合いやすそうです。",
    lightNextAction: "今日は、外へ向かう小さな一歩をひとつだけ選んでみる。",
    resultSheetLine: "いきなり大きく変えるより、少し連絡してみる、少し出てみる、少し試してみる。そのくらいの動きが、今は合いやすそうです。",
    nextStepCue: "今日は、外へ向かう小さな一歩をひとつだけ選んでみる。",
    privateLine: "いきなり大きく変えるより、少し連絡してみる、少し出てみる、少し試してみる。そのくらいの動きが、今は合いやすそうです。",
  },
];
