...
- **Deterministic + reproducible:** same (bankVersion, scoringVersion, answers) ⇒ same result on every channel. The canonical bank content hash is **already computed and pinned in the authored package** (`919f17251a280bb34258f6042db46bb9fd543763b33e041de64c36b305eaa9a6`); implementation must VERIFY this existing hash and must not generate a different hash for unchanged canonical content.
