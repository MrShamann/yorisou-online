...
| **CPV1 clean-main contract test** (`lib/cpv1/__tests__/cpv1Contract.test.ts`, pure `lib/cpv1` only) | **60 checks passed** |
...
| Migration-SQL guard (4 CM0 migrations) | PASS (forward additive; LOCAL_DISPOSABLE_SCHEMA_ROLLBACK) |
| Isolated disposable-DB migration/RLS | 25/25 (see CM0_MIGRATION_RLS.md) |
